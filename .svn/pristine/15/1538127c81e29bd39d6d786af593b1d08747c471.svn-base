...
public class OUTHERS23_VerifyInsertRowRightClick {
...
//	}
	...
	public void MPFIdentity(){
		...
		SW.LaunchBrowser(Environment.RESCON);
		SW.EnterValue("ResconLogin_Username_EB", SW.TestData("SGP_UserName"));
		SW.EnterValue("ResconLogin_Password_EB", SW.TestData("KDV4EM7C"));
		SW.Click("ResconLogin_Login_BT");
		SW.MoveToObject("ResconMpFlow_SelectEvent_BT");
		...
		SW.MoveToObject("ResconMpFlow_ExcelAddRowAbove_BT");
		SW.DoubleClick("ResconMpFlow_ExcelAddRowAbove_BT");
