...
/** Purpose		: This is to Validate FP Post-stay email in English language with GEI Offer 
 * TestCase Name: ValidateGEiPostStayEmailforFP
...
public class GC_REG41_ValidateGEiPostStayEmailforFP {
	CRM SW = new CRM();	
	String OfferTitle;
	...
	public void StartTest(){
		...
		if(Environment.getRunEnvironment().equalsIgnoreCase("QA3")){
			RequestXMLFile= "GC_REG41_ValidateGEiPostStayEmailforFP_1140_QA3.xml";
			PropertyID="1140";
		}
	...
	public void CreateReservation(){
		...
		String FutureArrivalDate= SW.DateAddDays(SW.GetTimeStamp("yyyy-MM-dd"), "yyyy-MM-dd", 11, Calendar.DATE);
		String FutureDepartureDate=SW.DateAddDays(SW.GetTimeStamp("yyyy-MM-dd"), "yyyy-MM-dd", 12, Calendar.DATE);
