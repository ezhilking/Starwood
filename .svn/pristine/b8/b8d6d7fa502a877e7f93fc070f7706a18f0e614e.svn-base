...
public class SMOKE004_LocateGuestByLastNameAndZipCode {
	...
	@Test
	public void SearchGuestSPGName() {
		...
		SW.EnterValue("NavigatorHomePage_CityOrZipCode_EB", "560103"+ Keys.TAB); // Entering the Zip COde value
