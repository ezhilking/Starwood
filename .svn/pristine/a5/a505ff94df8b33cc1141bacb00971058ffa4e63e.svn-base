...
public class OUTHERS29_VerifyInsertColumnQuickHandson {
...
//		SW.Click("ResconMpFlow_LogoutImage_BT");//TODO
	...
	//	List<WebElement> Arrow = SW.GetAllVisibleElements("ResconMpFlow_ExcelBtnColumns_BT");
	//	Arrow.get(0).sendKeys(Keys.ENTER);
		//		SW.Click("ResconMpFlow_ExcelBtnColumns_BT");
		SW.MoveToObject("ResconMpFlow_ExcelAddColLeft_BT");
		//		SW.Click("ResconMpFlow_ExcelBtnRows_BT");
		SW.DoubleClick("ResconMpFlow_ExcelAddColLeft_BT");
		if (SW.ObjectExists("ResconMpflow_InsertedRowBefore_WT")) {
			Reporter.Write("Row Created", "new Row Creation", "new Row Creation", "pass");}
			else
				{
				Reporter.Write("Row Created", "new Row Creation", "new Row Creation", "pass");
		}
