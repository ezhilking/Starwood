...
/** Purpose		: Validate LC AHBB SBSP email in English language using DWH
 * TestCase Name: Validate LC AHBB SBSP email in English language using DWH
 * Created By	: Sachin
 * Modified By	: 
 * Modified Date: 
 * Reviewed By	:	
...
public class GC_REG68_ValidateLCAHBB_SBSPEnglishLang_DWH {
	CRM SW = new CRM();	
