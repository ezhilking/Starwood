...
/** Purpose		: Validate the Offer Expiration email (7 day prior) for Prestay offer
 * TestCase Name: Validate the Offer Expiration email (7 day prior) for Prestay offer
...
public class GC_REG24_ValidateOfferExpirationEmail7DaysPrior {
	...
	public void GCCreateGEIPreStayoffer(){
		try{
			...
			SW.EnterValue("GCCreateResConf_presentationEndDate_EB", SW.DateAddDays( SW.GetTimeStamp("MM/dd/yyyy"),"MM/dd/yyyy",7,Calendar.DATE));
