...
public class SPGLink_REG29_VerifyMisStayReject {
		CRM SW = new CRM();
		...
		public void VerifyMisStayApprove() {
			...
			SW.DropDown_SelectByText("SPGLink_Verification_DD", "Reject");
			SW.DropDown_SelectByText("SPGLink_MisStayVeri_RejectReason_DD", "Stay already posted");
