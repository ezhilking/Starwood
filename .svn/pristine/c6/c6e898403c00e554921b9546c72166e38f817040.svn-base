...
public class AMS02_NewHireValidation {
...
//		SW.RunJavaScript("document.getElementsByName('PWE1')[0].value='"+Date+"';");
	...
	public  void ad() {
		...
		SW.EnterValue("AMS_NewHireValidation_username_LK",SW.TestData("IAMUserID"));
		SW.EnterValue("AMS_NewHireValidation_password_LK",SW.TestData("IAMPassword"));
		SW.Click("AMS_NewHireValidation_login_LK");
		SW.NormalClick("AMS_NewHireValidation_Manage_LK");
		//SW.EnterValue("AMS_NewHireValidation_UserHomePage_LK",);
		SW.Click("//a[text()='"+Position+"']");
