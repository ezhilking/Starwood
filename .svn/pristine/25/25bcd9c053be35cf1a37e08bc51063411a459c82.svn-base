...
/** Purpose		: Validate AHBB MBMP email in French language for Aloft,Non-Branded and  St.Regis brands
 * TestCase Name: GC_REG66_ValidateAHBBMBMPEmailFrenchlangAloft_NB_StRegis
...
public class GC_REG66_ValidateAHBBMBMPEmailFrenchlangAloft_NB_StRegis {
	CRM SW = new CRM();	
	...
	@Test(priority=1)
	public void CreateAHBBMBMPOfferFrenchLang(){
	...
	@Test(priority=2, dependsOnMethods="CreateAHBBMBMPOfferFrenchLang")
	public void databaseUpdateforAHBB(){
		...
		try{	
			...
			String UpdateLanguageCode="update CRMSTG.GC_GUEST set LANGUAGE_CD='FRA' where CURRENT_GST_MASTER_PROF_ID in ("+GMPID+")";
