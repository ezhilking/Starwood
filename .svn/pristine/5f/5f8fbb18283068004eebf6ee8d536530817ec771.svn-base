...
/* Purpose		: Create a Customer Impacting Event - CIE file
 * TestCase Name: REG3_CreateCIEFile
 ...
 * Reviewed Date:
 */
public class REG03_CreateCIEFile {
	CRM SW = new CRM();
	String CSFFileNo;
	String sPropId="1965";
	...
	public void CSFCreateCIEFile(){
		...
		SW.DropDown_SelectByText("CSFHome_TypeCreate_DD", "Customer Impacting Event");
		...
		//SW.DropDown_SelectByIndex("CSFSummary_ContactType_DD", 1);
		...
		SW.EnterValue("CSFSummary_CCCNum_EB", "589");
		SW.EnterValue("CSFSummary_Country_EB", "US");
		SW.EnterValue("CSFSummary_CCUserID_EB","SPG Program");
		SW.Wait(3);
