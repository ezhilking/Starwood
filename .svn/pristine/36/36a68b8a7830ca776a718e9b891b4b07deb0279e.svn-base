...
/* Purpose		: This script for US6539-Validation Message - Mismatched Length Of Stay
 * TestCase Name: US6539-Validation Message - Mismatched Length Of Stay
...
public class REG60_ValidationMessage_MismatchedLengthOfStay {
	...
	public void StartTest(){
		...
		Errormsg="Length of stay is not same as the number of nights for this award.";
	}
	@Test(priority=1)
	...
	public void ValidateMismatchLOS(){
		...
		if(SW.ObjectExists("NavigatorAwardPAge_SystemMessage_DT")){
			...
			Environment.loger.log(Level.ERROR, "No Such object Found");
	}
	@AfterClass
	public void EndTest(){
		SW.NavigatorLogOut();
