...
public class GC_REG98_ValidateTemporaryPropertyAccessDoNotAllowAlphaOrSepcialCharsEntry {
	...
	public void AlphaAndSpecialCharsValidation(){
		...
		//	SW.CompareText("Validate Property ID Field Text", "ABCD", PropertyText2);
				...
				Reporter.Write("Validate Property ID Field Text", "Alphabets cannot be entered in Property field in 'Property Access Expiration' window", "Alphabets are not entered in Property field in 'Property Access Expiration' window", "PASS");
			}
			...
			//SW.CompareText("Validate Property ID Field Text", "!@#$", PropertyText3);
				...
				Reporter.Write("Validate Property ID Field Text", "Special Characters cannot be entered in Property field in 'Property Access Expiration' window", "Special Characters are not entered in Property field in 'Property Access Expiration' window", "PASS");
			}
