...
/* Purpose		: validating error alert message when other than excel or PDF is uploaded in SPG user in view MB page
...
public class MUSTRUN20_01_MBOtherThanExcelOrPDFViewMBSPG {CHANNELS SW = new CHANNELS();
String Number;
String cnfcNumber;
...
public void StartTest(){
	...
	public void CreateMasterbillSPGinviteModify(){
		...
		SW.EnterValue("ResconMB_SPGFileDescription1_EB", "file other than Excel or PDF");
		SW.FileUpload("ResconMB_SPGFileUpload3_BT", "ethics and compliance traning.docx");
