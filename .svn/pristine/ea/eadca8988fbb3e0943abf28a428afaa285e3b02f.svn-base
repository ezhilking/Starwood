...
/** Purpose		: This is to Reject the event in SPG Link 2.0 under SPG Pro Approver Role
 * TestCase Name: EventProReject
...
public class SPGLink_REG18_EventProReject {
	CRM SW = new CRM();
	String EventName;
	@BeforeClass
	...
	public void EventProReject(){
		...
		if(SW.ObjectExists("SPGLinkEventListing_FirstEvent_LK")==false)
			SW.FailCurrentTest("No Event present to Approve");
