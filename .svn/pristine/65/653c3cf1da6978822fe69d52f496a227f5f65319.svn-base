...
/* Purpose		: This script for Downgrade A Member
 * TestCase Name: US5347-Downgrade A Member
...
public class REG57_DowngradeMember {
	...
	public void upgradeMember(){
		expected_SPGLabel="SPG "+SW.TestData("SPGLeveltoDowngrade");
		SW.WaitTillElementToBeClickable("NavigatorSearchPage_GuestNAme_DT");
		...
		SW.DropDown_SelectByText("NavigatorSearchPage_SPGLevel_DD", SW.TestData("SPGLeveltoDowngrade"));
		SW.Wait(3);
