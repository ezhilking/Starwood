...
/** Purpose		:	Notification Triggered when SPG WeChat Member reach P100
 * TestCase Name:	REG10_ReachPlatinumP100.java
...
public class REG10_ReachPlatinumP100 {
	...
	public void dbValidtion()
	{
		try{	
			...
			CheckQuery="select * from freq_travel_call_comm where call_comm_Cd='WCT' and mbrshp_num in ("+spgMem+")and call_comm_text in ('MEMBER EARNED P100 BENEFITS','STARPOINTS POSTED FOR A STAY.')";
			if(SW.RecordExists(CheckQuery))
