...
/** Purpose		: Validate AHBB MBMP email in Japanese language for Tribute and Design  brands
 * TestCase Name: Validate AHBB MBMP email in Japanese language for Tribute and Design  brands
...
public class GC_REG64_ValidateAHBBMBMPEmailJapanlangTributeandDesignbrands {
	CRM SW = new CRM();	
	...
	@Test(priority=1)
	public void CreateAHBBMBMPOfferJapaneseLang(){
	...
	@Test(priority=2, dependsOnMethods="CreateAHBBMBMPOfferJapaneseLang")
	public void databaseUpdateforAHBB(){
		...
		try{	
			...
			String UpdateLanguageCode="update CRMSTG.GC_GUEST set LANGUAGE_CD='JPN' where CURRENT_GST_MASTER_PROF_ID in ("+GMPID+")";
