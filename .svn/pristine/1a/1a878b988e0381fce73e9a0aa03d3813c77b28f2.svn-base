...
/* Purpose		: Create a Hotel Assist - HTA file
 * TestCase Name: REG04_CreateHTAFile.java
 ...
 * Reviewed Date:
 */
public class REG04_CreateHTAFile {
	CRM SW = new CRM();
	String CSFFileNo;
	String sPropId="1965";
	...
	public void CSFCreateHTAFile(){
		...
		SW.DropDown_SelectByText("CSFHome_TypeCreate_DD", "Hotel Assist");
		...
		String GCDText="Hotel Assist/Hotel Assist/"+SW.DropDown_GetSelectedText("CSFDetails_Detail_DD");
