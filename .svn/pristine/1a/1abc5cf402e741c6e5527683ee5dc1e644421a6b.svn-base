...
/** Purpose		: ValidateFP  AHBB SBMP email in Italian language 
 * TestCase Name: ValidateFP  AHBB SBMP email in Italian language 
 * Created By	: Sachin
 * Modified By	: 
 * Modified Date: 
 * Reviewed By	:	
...
public class GC_REG62_ValidateFPAHBB_SBMPItalianLanguage {
	CRM SW = new CRM();	
	...
	@Test(priority=1)
	public void CreateAHBBSBMPOfferItalianLang(){
	...
	@Test(priority=2,dependsOnMethods="CreateAHBBSBMPOfferItalianLang")
	public void databaseUpdateforAHBB(){
		try{	
			...
			String UpdateLanguageCode="update CRMSTG.GC_GUEST set LANGUAGE_CD='ITL' where CURRENT_GST_MASTER_PROF_ID in ("+GMPID+")";
