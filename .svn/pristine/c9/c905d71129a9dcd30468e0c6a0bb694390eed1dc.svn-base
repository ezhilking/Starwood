...
/** Purpose		: Validate Sheraton mystay email in Chinese language
 * TestCase Name: Validate Sheraton mystay email in Chinese language
 * Created By	: Sachin
 * Modified By	: 
 * Modified Date: 
 * Reviewed By	:	
...
public class GC_REG72_ValidateFPMyStayEmailChineseLanguage {
	...
	public void createNewReservation() {
		...
		/*	if(!SW.ObjectExists("BWSelectRoom_Reserve_BN")){
			...
			SW.Click("//*[@id='languageSelectorTop']/span");
			SW.Wait(10);
			SW.Click("//*[@id='languagesList']//a[text()='中文(简体)']"); 
			
			// Change locators to chinese from here
			SW.Click("//a[text()='给亲友发送电子邮件']");
