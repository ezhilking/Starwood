package testscripts.resCon;
	...
	public class OUTHERS03_ValidateOriginalFileWithFileStatusNEW {
...
//			Utility.CloseBrowser();
		...
		public void MPFIdentity(){
			...
			SW.ObjectExists("ResconMpFlow_NewOriginalFile_DT");
			if (SW.ObjectExists("ResconMpFlow_NewOriginalFile_DT")) {
				Reporter.Write("OriginalFile", "ResconMpFlow_NewOriginalFile_DT", "ResconMpFlow_SelectFileEventForNewFile_BT", "successfull");
				
			} else {
				Reporter.Write("OriginalFile", "ResconMpFlow_NewOriginalFile_DT", "ResconMpFlow_SelectFileEventForNewFile_BT", "Fail");
			}	
		}
