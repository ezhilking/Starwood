...
/* Purpose		: Validate Display Select File field for an Event with 1 file_NEW
 * TestCase Name: Validate Display Select File field for an Event with 1 file_NEW
 * Created By	: Muneeb
 * Modified By	: ResconMp_SelectFileEventForNewFile
...
public class MUSTRUN12_ResconMpSelectFileEventForNewFile {
	...
	public void MPFIdentity(){
		...
		SW.DropDown_SelectByValue("ResconMpFlow_SelectFileEventForNewFile_DD", "3931550:0");

		if(SW.IsEnabled("ResconMpFlow_SelectFileEventForNewFile_DD", "Enabled")){
			Reporter.Write("ResconMpFlow_SelectFileEventForNewFile_DD", "DropDown button should be enabled", "DropDown button is enabled", "PASS");
		}else{
			Reporter.Write("ResconMpFlow_SelectFileEventForNewFile_DD", "DropDown button shouldnot be enabled", "DropDown button is disabled", "FAIL");
		}
	}
