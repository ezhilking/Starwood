...
public class OUTHERS36_VerifyFunctionalitySpaceDelimiter {
...
//		SW.Click("ResconMpFlow_SaveChanges_BT");
		...
		SW.DoubleClick("ResconMpFlow_SelectFirstName_ST");
	//	SW.EnterValue("ResconMpFlow_SelectFirstName_ST", ",diksha");//not working
		
		String delimit= ",diksha";
		//List<WebElement> Firstname = SW.GetAllVisibleElements("ResconMpFlow_SelectFirstName_ST");
		//System.out.println(Firstname);
		//Firstname.get(0).sendKeys(Keys.DELETE);
		//Firstname.get(0).sendKeys(delimit);
		String Lname=SW.GetText("ResconMpFlow_Lname_DT");
		SW.EnterValue("ResconMpFlow_Lname_DT", Lname+" "+delimit);
//		SW.ClearValue("ResconMpFlow_SelectFirstName_ST");
//		SW.EnterValue("ResconMpFlow_SelectFirstName_ST",  delimit);
		SW.Click("ResconMpFlow_splitBtn_BT");
	//	SW.SwitchToWindow(2);
		SW.SelectRadioButton("ResconMpFlow_DelimComma_RB");
		SW.Click("ResconMpFlow_DelimOk_BT");
		SW.SwitchToWindow(1);
