...
public class SMOKE013_LocateGuestByLastNameCountryState {
	...
	@Test
	public void SearchGuestSPGNameCountryAndState() {
		...
		SW.EnterValue("NavigatorHomePage_LastName_EB", exp_lastName+ Keys.TAB); //Entering the last name
		/*SW.Click("NavigatorHomePage_Country_BT");
		SW.EnterValue("NavigatorHomePage_Country_EB", "India - IN" + Keys.TAB);*/
		SW.Click("NavigatorHomePage_State_BT");
		SW.EnterValue("NavigatorHomePage_State_EB", "KARNATAKA"+ Keys.TAB);
