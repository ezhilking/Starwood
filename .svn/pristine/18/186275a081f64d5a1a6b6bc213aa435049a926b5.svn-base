...
public class MEETINGS_REG16_ChangeReservationReview {
	...
	public void ChangeReservationReviewPage(){
		...
		try{
			...
			if(SW.CompareText("ChangeReservationReviewPage_FirstNameValidation_DT", "Mr. "+firstName, FirstSpecialCharacter[0]))
			{
				Reporter.WriteLog(Level.INFO, "Pass");
			}
			else
			{
				Reporter.WriteLog(Level.INFO, "Fail");
			}
			
			if(SW.CompareText("ChangeReservationReviewPage_LastNameValidation_DT", lastName, FirstSpecialCharacter[1]))
			{
