...
/* Purpose		: To Validating Alert message on the Home page of the ResCon application as Admin User
 * TestCase Name: TC1_ Verify the alert message on the home page when you login for Admin_User
...
public class MUSTRUN14_AlertMessageOnHomeAdminUser {
