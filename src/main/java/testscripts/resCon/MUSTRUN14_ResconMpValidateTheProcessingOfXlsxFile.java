/* Purpose		: Validate the Processing of  .Xlsx file
 * TestCase Name: Validate the Processing of  .Xlsx file
 * Created By	: Muneeb
...
public class MUSTRUN14_ResconMpValidateTheProcessingOfXlsxFile {
...
//	String EventName = "MuGhZJ";
	...
	public void Admin()
	{
		...
		SW.EnterValue("ResconLogin_SGP_UserName_EB", MailID);//No need to navigateTo RESCON homepage
	...
	public void MPFIdentity(){
		...
		SW.LaunchBrowser(Environment.RESCON);
		SW.EnterValue("ResconLogin_SGP_UserName_EB", SW.TestData("SGP_UserName"));
		SW.EnterValue("ResconLogin_Password_EB", SW.TestData("password"));
		SW.Click("ResconLogin_Login_BT");
		SW.MoveToObject("ResconMpFlow_SelectEvent_BT");
