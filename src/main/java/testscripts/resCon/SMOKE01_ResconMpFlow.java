/* Purpose		: VERRIFING UPLOADING OF FILE AND DOING RESERVSATION
 * TestCase Name: '[1]TC11_Upload Excel spreadsheet for group - Happy Day
 * Created By	: Muneeb
 * Modified By	: SMOKE01_ResconMpFlow
...
public class SMOKE01_ResconMpFlow {
	...
	public void MPF(){
		...
		SW.EnterValue("ResconLogin_Username_EB", SW.TestData("username"));
		...
		SW.EnterValue("ResconMpFlow_Email_EB", SW.TestData("email"));
	...
	public void Admin()
	{
		...
		SW.SwitchToWindow(2);
		SW.FileUpload("ResconMpFlow_FileContentBrowse_BT", "RL.xlsx");
