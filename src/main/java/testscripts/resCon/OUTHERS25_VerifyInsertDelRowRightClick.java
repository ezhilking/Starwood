...
public class OUTHERS25_VerifyInsertDelRowRightClick {
...
//	String EventName = "MuGhZJ";
	...
	public void Admin()
	{
		...
		//  Bring back the control to the primary window
			...
			SW.CompareText("ResconMpFlow_UploadTable_WT", "3",Integer.toString(rowCount));
		SW.Click("ResconMpFlow_LogoutImage_BT");
		//TODO
	...
	public void MPFIdentity(){
		...
		SW.CompareText("ResconMpFlow_UploadTable_WT", "3",Integer.toString(FinalrowCount));
		...
		SW.DoubleClick("ResconMpFlow_ExcelBtnRows_BT");
		SW.MoveToObject("ResconMpFlow_ExcelRemoveRow_BT");
		SW.DoubleClick("ResconMpFlow_ExcelRemoveRow_BT");	
		SW.WebTbl_GetRowCount("");
		SW.CompareText("ResconMpFlow_ExcelRemoveRow_BT", "Removal of row", "Row Deleted");
		Reporter.Write("ResconMpFlow_ExcelRemoveRow_BT", "Removal of row", "Row Deleted", "Pass");
	}
	@AfterClass
	public void EndTest(){
		Reporter.StopTest();		
