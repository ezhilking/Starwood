...
/* Purpose		: Verify uploading Excel file which is less than 10 MB for master bill new SPG user page
 * TestCase Name: TC17_Verify  uploading an Excel file_Size less than 10MB_New Master Bill page
...
public class MUSTRUN28_01_MBUploadLessThan10MBExcelFileSPG {
	...
	public void CreateMasterbillSPGinviteAdminUser(){
		...
		SW.EnterValue("ResconMB_SPGEventname_EB","Uploadlessthan10mbfile");
