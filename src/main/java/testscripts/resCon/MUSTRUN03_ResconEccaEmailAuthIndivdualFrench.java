 ...
 public class MUSTRUN03_ResconEccaEmailAuthIndivdualFrench {
	 ...
	 public void Admin(){
		 ...
		 if (SW.ObjectExists("ResconEccaFlow_LanguageID_ST")) {
			 Reporter.Write("ResconEccaFlow_LanguageID_ST","The  Object Exixst", "success", EventName);

		 } else {
			 Reporter.Write("ResconEccaFlow_LanguageID_ST","The doesnt Object Exixst" ,"Fail", EventName);
		 }
