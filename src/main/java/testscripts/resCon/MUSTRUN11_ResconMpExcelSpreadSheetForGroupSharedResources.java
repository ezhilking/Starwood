/* Purpose		: Upload Excel spreadsheet for group with share with reservations
 * TestCase Name: Upload Excel spreadsheet for group with share with reservations
 * Created By	: Muneeb
 * Modified By	: Muneeb
...
public class MUSTRUN11_ResconMpExcelSpreadSheetForGroupSharedResources {
	...
	public void Admin()
	{
		...
		SW.SwitchToWindow(2);
		SW.FileUpload("ResconMpFlow_FileContentBrowse_BT", "Rooming_ListForGroup_Template1.xlsx");	
