...
public class OUTHERS10_VerifySearchInputFieldMoreThan30Characters {
...
//		SW.Click("ResconMpFlow_View_BT");
		...
		String charThirty="qwertyqwertyqwertyqwertyqwertyqqqqqqqqqq";
		String charThirty1=SW.GetText("ResconMpFlow_SearchExcel_EB");
		SW.EnterValue("ResconMpFlow_SearchExcel_EB", charThirty);
		SW.Click("ResconMpFlow_SaveChanges_BT");
		Reporter.Write("characters in search", charThirty1, charThirty,"Pass" );
