...
public class SPGBatch_Delta {
	...
	public void SPGBatch_Delta_DataSetup() {
		...
		/*Step 2: Query2 --> Check whether member has any extl linked, if yes, delete it and link it with DELTA and DELTADC*/
		...
		List<String> seq_num=SW.GetColumnValues("select seq_num from prc_ft_batch_parm where parm_name='QUAL_STAY_LAST_TMSTMP' and job_name='DLQUALST'", "seq_num");
		String seq_num1=seq_num.get(0);
		String Query7="update prc_ft_batch_parm set parm_value='"+Late_Qual_tmstmp+"' where seq_num='"+seq_num1+"' and job_name='DLQUALST'";
