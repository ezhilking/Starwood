...
/** Purpose		: Validate LC SWAQ codes and requested check-in time in suppressed rate reservation email  in Spanish language with SPG preferences Offer
 * TestCase Name: Validate LC SWAQ codes and requested check-in time in suppressed rate reservation email  in Spanish language with SPG preferences Offer
 * Created By	: Sachin
 * Modified By	: Sachin
...
/* Purpose		: Validate LC SWAQ codes and requested check-in time in suppressed rate reservation email  in Spanish language with SPG preferences Offer
 * TestCase Name: ValidateSWAQCodesinResconfEmailwithSPGoffer
...
public class GC_REG38_ValidateSWAQCodesinResconfEmailwithSPGoffer {
	...
	public void StartTest(){
		...
		if(Environment.getRunEnvironment().equalsIgnoreCase("QA3")){
			RequestXMLFile= "GC_REG38_ValidateSWAQCodesinResconfEmailwithSPGoffer.xml";
		}if(Environment.getRunEnvironment().equalsIgnoreCase("QA2")){
			RequestXMLFile= ".xml";	
		}
	}
	@Test(priority=1)
	public void GCCreateSPGResConOffer(){
		try{
			...
			SW.DropDown_SelectByText("//select[@name='localeName']", "Spanish (Spain)");
	...
	@Test(priority=2,dependsOnMethods={"GCCreateSPGResConOffer"})
