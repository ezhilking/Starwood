...
/** Purpose		: Validate LM Brand Reservation Confirmation Offer creation in English language
 * TestCase Name: Validate LM Brand Reservation Confirmation Offer creation in English language
...
public class GC_REG16_ValidateLMBrandResConOfferEnglish {
	...
	//	SW.EnterValue("GC_EnterLanguageText_EB", "English (United States)");
		...
		SW.Click("GCCreateResConf_Continue_BN");
		SW.Wait(10);
		if(SW.ObjectExists("GCCreateBrandSurveytitle_FR")){
