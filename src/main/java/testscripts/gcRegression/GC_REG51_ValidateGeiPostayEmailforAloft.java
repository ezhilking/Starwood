...
/** Purpose		: Validate Aloft Post-stay email in Thai language
 * TestCase Name: Validate Aloft Post-stay email in Thai language
...
public class GC_REG51_ValidateGeiPostayEmailforAloft {
	CRM SW = new CRM();	
	String OfferTitle;
	...
	public void StartTest(){
		...
		if(Environment.getRunEnvironment().equalsIgnoreCase("QA3")){
			RequestXMLFile= "GC_REG51_ValidateGeiPostayEmailforAloft_3003_QA3.xml";
			PropertyID="3003";
		}
		if(Environment.getRunEnvironment().equalsIgnoreCase("QA2")){
			RequestXMLFile= "GC_REG51_QA2_Aloft_1314.xml";
			PropertyID="1314";
		}
	}
	...
	public void GCCreateGEIPostStayoffer(){
		try{
			...
			SW.DropDown_SelectByText("GCCreateResConf_Language_DD","Thai (Thailand)");
