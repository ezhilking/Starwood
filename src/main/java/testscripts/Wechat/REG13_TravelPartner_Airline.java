...
/** Purpose		:	Notification Triggered when Points deducted / awards Travel Partner (Airline)
 * TestCase Name:	REG13_TravelPartner_Airline.java
 ...
 * Reviewed Date: 
 */
public class REG13_TravelPartner_Airline {
	CRM SW = new CRM();	
	...
	public void StartTest(){
		...
		sExtMember="6000962792";
		sPointTransfer="5532";
	}
	@Test(priority=1)
	public void TravelPartner_Airline()
	{
		...
		SW.EnterValue("CoronaCreateMbrAwd_AwardId_EB", "DELTA");
		SW.EnterValue("CoronaCreateMbrAwd_UserID_EB", sUsername);
		SW.EnterValue("CoronaCreateMbrAWd_CommentText_EB", "Airline Transfer");
	...
	@Test(priority=2, dependsOnMethods="TravelPartner_Airline")
	public void dbValidtion()
	{
		try{	
			...
			CheckQuery="select * from freq_travel_call_comm where call_comm_Cd='WCT' and mbrshp_num in ("+spgMem+") and call_comm_text = 'AWARDS DELTA AIRLINES ISSUED.'";
			if(SW.RecordExists(CheckQuery))
