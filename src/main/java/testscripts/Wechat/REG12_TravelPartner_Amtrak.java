...
/** Purpose		:	Notification Triggered when Points deducted / awardsTravel Partner (AMTRAK)
 * TestCase Name:	REG12_TravelPartner_Amtrak.java
 ...
 * Reviewed Date: 
 */
public class REG12_TravelPartner_Amtrak {
	CRM SW = new CRM();	
	...
	public void StartTest(){
		...
		sExtMember="4119853564";
		sPointTransfer="5502";
	}
	@Test(priority=1)
	public void TravelPartner_Amtrak()
	{
		...
		SW.EnterValue("CoronaCreateMbrAwd_AwardId_EB", "AMTRAK");
		SW.EnterValue("CoronaCreateMbrAwd_UserID_EB", sUsername);
		SW.EnterValue("CoronaCreateMbrAWd_CommentText_EB", "AMTRAK Transfer");
	...
	@Test(priority=2, dependsOnMethods="TravelPartner_Amtrak")
	public void dbValidtion()
	{
		try{	
			...
			CheckQuery="select * from freq_travel_call_comm where call_comm_Cd='WCT' and mbrshp_num in ("+spgMem+") and call_comm_text = 'AWARDS AMTRAK TRANSFER ISSUED.'";
			if(SW.RecordExists(CheckQuery))
