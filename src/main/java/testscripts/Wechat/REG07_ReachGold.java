...
/** Purpose		: Trigger notification for Reach Gold
 * TestCase Name: REG07_ReachGold.java
...
public class REG07_ReachGold {
	...
	@Test(priority=2, dependsOnMethods="reachGold")
	public void dbValidtion()
	{
		try{	

			SW.Wait(50);//for reflect into DB
