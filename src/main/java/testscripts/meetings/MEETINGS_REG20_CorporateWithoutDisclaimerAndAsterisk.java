...
public class MEETINGS_REG20_CorporateWithoutDisclaimerAndAsterisk {
	...
	public void CorporateChildrenDisclaimerandAsterik(){
		...
		SW.TakeScreenshot("COREngLangScreenshotFindRooms&RatesPageWithoutChildren");	
		...
		if(!(SW.ObjectExists("MeetingsGuest_Children_DD") && SW.ObjectExists("MeetingsGuest_ChildrenDisclamerText_DD"))){
			Reporter.Write("CorporateChildrenDisclamerText_ST", "Object is not present on Available Rooms", "Object is not present on Available Rooms", "PASS");
		}else{
			Reporter.Write("CorporateChildrenDisclamerText_ST", "Object is present on Available Rooms", "Object is present on Available Rooms", "FAIL");
		}
		
		SW.TakeScreenshot("COREngLangScreenshotAvailableRoomsPageWithoutChildren");
		...
		SW.TakeScreenshot("CORJapLangScreenshotFindRooms&RatesPageWithoutChildren");	
		SW.EnterValue("MeetingsBooking_CheckIn_EB", SW.TestData("SGP_CheckIn"));
		SW.EnterValue("MeetingsBooking_CheckOut_EB", SW.TestData("SGP_CheckOut"));
		SW.Click("MeetingsBooking_Search_BT");
		...
		SW.TakeScreenshot("CORJapLangScreenshotAvailableRoomsPageWithoutChildren");
	}
