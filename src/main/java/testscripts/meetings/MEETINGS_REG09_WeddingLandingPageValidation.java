/* Purpose		: //TODO
 * TestCase Name: how all it started Event Description text validation for wedding in booking landing page for english & japanese language
 * Created By	: Brij
 * Modified By	: 	
 * Modified Date: 
 * Reviewed By	: 
...
public class MEETINGS_REG09_WeddingLandingPageValidation {
	...
	public void WeddingWebsiteForEventDescription(){
		...
		SW.TakeScreenshot("How all started Screenshot");
		SW.Click("MeetingsCorporate_NextButton_BT");
		try{
	...
	public void BookingPageValidationEventDescription(){
		...
		String [] started = a.split("  ");
		//		System.out.println(started[0]);
		//		System.out.println(started[1].trim());
		//		System.out.println(started[2].trim());
		//		System.out.println(started[3].trim());

		if(SW.CompareText("EventDescriptionBookingLandingPageEnglish_DD", eventDesc, started[0]+"\n"+started[1].trim()+"\n"+started[2].trim()+"\n"+started[3].trim()))
		{
	...
	@Test(priority=3,dependsOnMethods="WeddingWebsiteForEventDescription")

	public void BookingPageValidationEventDescriptionJapanese()
	{
