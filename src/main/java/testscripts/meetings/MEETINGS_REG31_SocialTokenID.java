/* Purpose		: //TODO
 * TestCase Name: TokenID - Z email text Social
 * Created By	: Brij 
 * Modified By	: 	
 * Modified Date: 
 * Reviewed By	: 
...
public class MEETINGS_REG31_SocialTokenID {
	...
	public void TokenIDEmailCorporate(){
		...
		SW.EnterValue("MeetingsCorporate_MeetingID_EB", SW.TestData("SocialMeetingID"));
		SW.Click("MeetingsCorporate_Search_BT");
		SW.Click("MeetingsCorporate_SendEmail_LK");
		SW.SwitchToWindow(2);
		TokenIDURL = SW.GetCurrentURL();
		String tokenID = TokenIDURL+"fhu$&*@f8243";
