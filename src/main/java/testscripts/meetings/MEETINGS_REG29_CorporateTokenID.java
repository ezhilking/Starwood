/* Purpose		: //TODO
 * TestCase Name: TokenID - Z email text corporate
 * Created By	: Brij 
 * Modified By	: 	
 * Modified Date: 
 * Reviewed By	: 
...
public class MEETINGS_REG29_CorporateTokenID {
	...
	public void TokenIDEmailCorporate(){
		...
		SW.EnterValue("MeetingsCorporate_MeetingID_EB", SW.TestData("CorporateMeetingID"));
		SW.Click("MeetingsCorporate_Search_BT");
		SW.Click("MeetingsCorporate_SendEmail_LK");
		SW.SwitchToWindow(2);
		TokenIDURL = SW.GetCurrentURL();
		String tokenID = TokenIDURL+"74hf&$(";
