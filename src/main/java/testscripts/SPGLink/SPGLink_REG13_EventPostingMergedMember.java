 ...
 * TestCase Name: EventPostingMergedMember
...
public class SPGLink_REG13_EventPostingMergedMember {
	CRM SW = new CRM();
	String Mbrshp_num; //Merged membership# Event should be posted to the ActiveMember Associated
	...
	@Test(priority=0)
	public void DataSetupMergedMember() {
		SW.EstablishConnection("QA3");
		List<String> MemberShip=SW.GetColumnValues("select * from freq_travel_mbrshp where mbrshp_sts='M' and mbrshp_lvl='A' and mrktg_pgm='5' and src_cd='DIGA' and join_date > (sysdate-365)", "Mbrshp_num");
	...
	@Test(priority=1,dependsOnMethods="DataSetupMergedMember")
	public void EventPostingMergedMbr(){
