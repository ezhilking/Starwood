...
/* Purpose		: Creating the file for Commission 
 * TestCase Name: REG07_Commission.java
...
public class REG07_Commission {
	...
	@Test(priority=0)
	public void CSFCreateCommissionFile(){
		...
		SW.EnterValue("CSFResConf_ArrivalDate_EB",SW.DateAddDays(SW.GetTimeStamp("dd MMM yyyy"), "dd MMM yyyy", -18, Calendar.DATE));
		SW.EnterValue("CSFResConf_ToDate_EB",SW.DateAddDays(SW.GetTimeStamp("dd MMM yyyy"), "dd MMM yyyy", -15, Calendar.DATE));
		...
		//SW.DropDown_SelectByIndex("CSFResolution_PaymentType_DD", 2);
