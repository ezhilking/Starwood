 ...
 * TestCase Name:  VP_MustRun05_Reg_PropMode_Create_SPGRatePlanOpera
 * Created By	:  Muneeb
 * Modified By	:
 * Modified Date:
 * Reviewed By	: 
...
public class MUSTRUN06_SPGRatePlanOpera {
...
//		SW.DropDown_SelectByIndex("VPRates_RPType_DD", 3);		
		...
		SW.DropDown_SelectByIndex("VPRates_RPType_DD", 3);//todo 5
