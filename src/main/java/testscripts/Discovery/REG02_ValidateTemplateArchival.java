...
public class REG02_ValidateTemplateArchival {
	...
	public void NonActiveSurveyTemplateArchival(){
		...
		if(SW.ObjectExists("//a[text()='"+UnArchivedTemplate+"']")){
			...
			Environment.loger.log(Level.ERROR, "Template not is present in the Archived Template page after Archival");
			SW.FailCurrentTest("Template is not present in the Archived Template page after Archival");
		}
