...
/* Purpose		: This script for China State Code Error - Edit Member Address
 * TestCase Name: US6616- China State Code Error - Edit Member Address
...
public class REG65_ChinaStateCodeErrorEditMemberAddress {
	...
	public void StartTest(){
		...
		SPGNUMBER=SW.TestData("China4StateCodeMember");
	}
	@Test(priority=0)
	...
	public void EditMemberAddress(){
		...
		SW.DropDown_SelectByText("NavigatorSearchPage_HomeCountry_DD", "China");
		SW.DropDown_SelectByText("NavigatorSearchPage_HomeState_DD", "Henan");
		...
		if(SW.CompareTextContained("CompareCountry", "China", getCountry))
			Environment.loger.log(Level.INFO, "The profile has updated successfully!!!");
	}
	@AfterClass
	public void EndTest(){
