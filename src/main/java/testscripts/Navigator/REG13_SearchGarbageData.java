...
/* Purpose		: SPG Search Garbage Data-Negative 
 * TestCase Name: REG13_SearchGarbageData.java
...
public class REG13_SearchGarbageData {
	...
	@Test
	public void SearchByGarbageData(){
		...
		SW.EnterValue("NavigatorHomePage_PhoneCountry_EB", "@Uyt-0");
