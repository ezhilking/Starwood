...
/* Purpose		: This script forAccount With US Address to check merchandise award
 * TestCase Name: US6698-Account With US Address
...
public class REG84_AccountWithUSAddress {
	...
	public void StartTest(){
		...
		SPGNUMBER=SW.TestData("USAddressMember");
		Awards=Arrays.asList("CNALL","BROOK150","AMZN100","AMZN150","AVIS$50","AMZN50","CNARD","BANA100","BANA25","BANA50","BLISS100","BLISS25","BLISS50","CNBNA","BROOK100","BROOK50","CNTVL","CNDET","GAP$25","GAP$50","CNGLM","CNGLF","CNGQM","ITUNE25","ITUNE50","CNLKY","MPI-100","MPI-25","NORD100","NORD150","NORD50","PCMA-100","PCMA-25","PB25","PB100","CNSLF","SIXT$50","PB50","SBUCK100","SBUCK25","SBUCK50","CNVOG","CNWMG","WS100","WS25","WS50","CNWIR");
	}
	@Test(priority=1)
