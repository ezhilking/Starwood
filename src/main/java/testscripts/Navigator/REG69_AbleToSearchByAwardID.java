...
/* Purpose		: This script for Able To Search By Award ID
 * TestCase Name: US6643-Able To Search By Award ID
...
public class REG69_AbleToSearchByAwardID {
	...
	public void ValidateSPGProAssistAward(){
		...
		if(SW.ObjectExists("NAvigatorAwardPage_SPGPRoAssistAward_LK"))
		{
			...
			SW.CompareText("Compare the Award Type", "DN", SW.GetText("NavigatorAwardPage_AwardType_DT"));
			SW.CompareText("Compare the Award Type", "CT", SW.GetText("NavigatorAwardPage_AwardCat_DT"));
		}
		else
